...
(function () {
    ...
    var Drawer = function (params) {
        ...
        this.toggleDrawer = function (obj) {
            ...
            if(document.querySelector('.drawer_main').classList.length == 1){
